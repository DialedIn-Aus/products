...
<p align="center">
    <img src="images/c3-breakout1.jpeg" alt="product image" width="600px" />
</p>
...
- 2x ADC inputs setup for [eTape](https://milonetech.com/products/standard-etape-assembly) or similar
- WS2812B RGB LED
...
If you dont want to use Tasmota there are plenty of other platforms that will work great with this module. Something for everyone here from writing custom code to configuration with a fully GUI controlled setup.
...
## Compatible Modules
The following modules are compatible with this board. Not all features supported on ESP8266 modules. Some modules require the addition of extra resistors (see datasheet).
